...
// 앱 전체화면을 전환하는 Stack Navigator객체 생성
        ...
        return(
            <NavigationContainer>
                <RootStack.Navigator screenOptions={{headerShown:false}}>
                    ...
                    <RootStack.Screen name="LoginStackNav" component={LoginStackNav}/>
                    <RootStack.Screen name="MainDrawerNav" component={MainDrawerNav}/>
                </RootStack.Navigator>
            </NavigationContainer>
        );
    }
